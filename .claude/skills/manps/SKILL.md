---
name: manps
description: "Preseason project health check. Scans for tech debt, stale TODOs, unused dependencies, missing tests, risky patterns, and optional safe remediation."
---

<!-- Managed by mancode:claude-skill. Do not edit this marker. -->

# mancode · /manps (Preseason)
